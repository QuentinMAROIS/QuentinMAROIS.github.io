...
setInterval(function() {
  ...
  t.html(function(){
    return timespan.days + " <span>jours</span> " + timespan.hours + " <span>heures</span> " + timespan.minutes + " <span>minutes</span> " + timespan.seconds + " <span>secondes</span>";
  })
...
function randombg(){
  ...
  var bigSize = ["url('src/background/bg1.jpg')",
                 "url('src/background/bg2.jpg')",
                 "url('src/background/bg3.jpg')",
                 "url('src/background/bg4.jpg')",
                 "url('src/background/bg5.jpg')",
                 "url('src/background/bg6.jpg')"];
